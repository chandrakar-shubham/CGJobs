...
class AiContentEngineController extends Controller
{
    ...
    public function settings(Request $request)
    {
        $data = $request->validate([
            ...
            'enabled'=>'nullable|boolean','daily_request_limit'=>'required|integer|min:1|max:100000',
            'daily_token_limit'=>'required|integer|min:1|max:100000000','max_items_per_request'=>'required|integer|min:1|max:100',
            'monthly_budget'=>'nullable|numeric|min:0','auto_publish_news'=>'nullable|boolean','auto_publish_jobs'=>'nullable|boolean',
        ]);
