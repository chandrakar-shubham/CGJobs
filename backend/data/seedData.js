/**
 * Seed data for CGJobs - Chhattisgarh Recruitment, News & Static GK
 */
...
const SEED_CATEGORIES = [
  // Jobs Categories
  { id: "all_jobs", name: "All Jobs", hindiName: "सभी भर्तियां", section: "jobs" },
  { id: "cgpsc", name: "CGPSC", hindiName: "सीजीपीएससी", section: "jobs" },
  { id: "cg_vyapam", name: "CG Vyapam", hindiName: "व्यापम", section: "jobs" },
  { id: "police_defence", name: "Police & Defence", hindiName: "पुलिस व सुरक्षा", section: "jobs" },
  { id: "teaching", name: "Teaching", hindiName: "शिक्षक भर्ती", section: "jobs" },
  { id: "patwari_revenue", name: "Patwari & Revenue", hindiName: "पटवारी व राजस्व", section: "jobs" },
  { id: "engineering", name: "Engineering & Tech", hindiName: "इंजीनियरिंग", section: "jobs" },
  { id: "medical_health", name: "Medical & Health", hindiName: "स्वास्थ्य व चिकित्सा", section: "jobs" },
  { id: "admit_card", name: "Admit Card", hindiName: "प्रवेश पत्र", section: "jobs" },
  { id: "result", name: "Result", hindiName: "परीक्षा परिणाम", section: "jobs" },
  { id: "answer_key", name: "Answer Key", hindiName: "उत्तर कुंजी", section: "jobs" },
  { id: "syllabus", name: "Syllabus", hindiName: "पाठ्यक्रम", section: "jobs" },

  // News & Current Affairs Categories
  { id: "all_news", name: "All Current Affairs", hindiName: "सभी (All)", section: "news" },
  { id: "national", name: "National", hindiName: "राष्ट्रीय", section: "news" },
  { id: "international", name: "International", hindiName: "अंतर्राष्ट्रीय", section: "news" },
  { id: "chhattisgarh", name: "State Special", hindiName: "छत्तीसगढ़", section: "news" },
  { id: "economy", name: "Economy & Budget", hindiName: "अर्थव्यवस्था", section: "news" },
  { id: "sports", name: "Sports & Awards", hindiName: "खेलकूद", section: "news" },
  { id: "schemes", name: "Government Schemes", hindiName: "सरकारी योजनाएं", section: "news" },
  { id: "environment", name: "Environment & Forest", hindiName: "पर्यावरण व भूगोल", section: "news" },

  // Static GK Categories
  { id: "all_gk", name: "All Topics", hindiName: "सभी (All)", section: "static_gk" },
  { id: "history", name: "History & Heritage", hindiName: "इतिहास", section: "static_gk" },
  { id: "geography", name: "Geography & Rivers", hindiName: "भूगोल", section: "static_gk" },
  { id: "culture_tribes", name: "Culture & Tribes", hindiName: "संस्कृति व जनजाति", section: "static_gk" },
  { id: "polity_economy", name: "Polity & Economy", hindiName: "राजव्यवस्था व अर्थव्यवस्था", section: "static_gk" },
  { id: "state_special", name: "State Special", hindiName: "छत्तीसगढ़ विशेष", section: "static_gk" }
];
...
const SEED_STATIC_GK = [
  ...
  },
  {
    ...
    facts: [
      ...
      "बौद्ध केंद्र: चीनी यात्री ह्वेनसांग ने 639 ईस्वी में सिरपुर की यात्रा की थी।"
    ],
  ...
  },
  {
    ...
    facts: [
      ...
      "मुख्य रस्में: पाट जात्रा, डेरी गड़ाई, काछिन गादी, बेल पूजा",
    ...
    examTip: "अक्सर पूछा जाता है: काछिन गादी रस्म में किस देवी की अनुमति ली जाती है? उत्तर: काछिन देवी।",
  ...
  },
  {
    ...
    examTip: "प्रतीक चिन्ह में 36 किले हरे रंग में, ऊर्जा का प्रतीक नीले रंग में और भारत का सारनाथ सिंह स्तंभ लाल रंग में अंकित है।",
  ...
  },
  {
    ...
    category: "इतिहास",
    summary: "कबीरधाम (कवर्धा) जिले में मैकल पर्वत श्रृंखला के बीच स्थित 11वीं शताब्दी का भोरमदेव मंदिर भगवान शिव को समर्पित है। अपनी अद्भुत मूर्तिकला के कारण इसे 'छत्तीसगढ़ का खजुराहो' कहा जाता है।",
    facts: [
      "निर्माण काल: 11वीं शताब्दी (1089 ईस्वी)",
      "राजवंश: फणि नागवंश (राजा गोपाल देव के शासनकाल में लक्ष्मण देव द्वारा)",
      "वास्तुकला: नागर शैली (चंदेल एवं कलचुरी शैली का सम्मिश्रण)",
  ...
  },
  {
    ...
    facts: [
      ...
      "लौह अयस्क: बैलाडीला (दंतेवाड़ा) - उच्च गुणवत्ता का हेमेटाइट अयस्क",
    ...
    examTip: "बैलाडीला की खदानें NMDC द्वारा संचालित हैं और यहाँ एशिया की सबसे बड़ी यंत्रीकृत खदान है।",
  ...
  },
  {
    ...
    facts: [
      ...
      "घोटुल: मुरिया जनजाति का युवागृह जिसके देवता 'लिंगोपेन' हैं।",
      "तीजा, पोला, हरेली: राज्य के प्रमुख पारंपरिक कृषि व लोक पर्व",
      "करमा नृत्य: उरांव, गोंड व बैगा जनजातियों का प्रमुख पारंपरिक नृत्य"
    ],
    examTip: "वेरियर एल्विन की प्रसिद्ध पुस्तक: 'द मुरिया एंड देयर घोटुल' एवं 'द बैगाज' (1939)।",
