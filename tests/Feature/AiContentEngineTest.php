...
class AiContentEngineTest extends TestCase
{
    ...
    private function generatedResult(int $id, string $title = 'Generated title'): array
    {
        return [
            ...
            'seo' => ['title' => 'SEO title', 'description' => 'SEO description', 'focus_keyword' => 'news', 'keywords' => ['news'], 'slug' => 'news', 'og_title' => 'OG', 'og_description' => 'OG', 'image_alt' => 'Image'],
        ];
    }

    private function provider(array $overrides = []): AiProviderSetting
    {
        return AiProviderSetting::create(array_merge(['provider' => 'gemini', 'api_key' => 'primary-secret', 'model' => 'gemini-2.5-flash', 'enabled' => true, 'daily_request_limit' => 100, 'daily_token_limit' => 100000, 'max_items_per_request' => 20], $overrides));
    }
    ...
    public function test_generated_news_is_saved_from_structured_response_and_uses_gemini_rest_json_mode(): void
    {
        ...
        Http::fake(['generativelanguage.googleapis.com/*' => function ($request) use ($body) {
            ...
            return Http::response(['candidates' => [['content' => ['parts' => [['text' => $body]]]]], 'usageMetadata' => ['promptTokenCount' => 100, 'candidatesTokenCount' => 200]], 200);
        }]);
    ...
    public function test_primary_failure_uses_fallback_provider(): void
    {
        ...
        Http::fakeSequence()->pushStatus(503)->push(['choices' => [['message' => ['content' => $body]]], 'usage' => ['prompt_tokens' => 50, 'completion_tokens' => 100]], 200);
    ...
    {
        Http::fake(['generativelanguage.googleapis.com/*' => Http::response(['error' => ['code' => 400, 'message' => 'Invalid JSON mode parameter']], 400)]);
        $news = News::create(['title' => 'Source title', 'status' => 'draft']);
        $this->provider();
    ...
    public function test_news_ingestion_uses_both_providers_deduplicates_and_sends_created_items_to_ai(): void
    {
        ...
        Http::fake([
            'newsdata.io/*' => Http::response(['results' => [
                ['title' => 'CGPSC Exam Update', 'description' => 'First real description', 'source_id' => 'NewsData', 'link' => 'https://example.com/one', 'pubDate' => '2026-09-08 10:00:00'],
                ['title' => 'Shared Recruitment Update', 'description' => 'Shared real description', 'source_id' => 'NewsData', 'link' => 'https://example.com/shared'],
            ]], 200),
            'newsapi.org/*' => Http::response(['articles' => [
                ...
                ['title' => 'New Education Update', 'description' => 'Second real description', 'source' => ['name' => 'NewsAPI'], 'url' => 'https://example.com/two'],
            ]], 200),
            'generativelanguage.googleapis.com/*' => Http::response(['candidates' => [['content' => ['parts' => [['text' => $aiBody]]]]], 'usageMetadata' => ['promptTokenCount' => 300, 'candidatesTokenCount' => 500]], 200),
        ]);
    ...
    public function test_ingestion_does_not_create_existing_url_or_case_insensitive_title_duplicates(): void
    {
        ...
        Http::fake(['newsdata.io/*' => Http::response(['results' => [
            ['title' => 'Existing CGPSC Update', 'description' => 'Existing story description', 'link' => 'https://other.example/title'],
            ['title' => 'Completely New Story', 'description' => 'A genuinely new story description', 'link' => 'https://example.com/new'],
            ['title' => 'Another New Story', 'description' => 'Another story description', 'link' => 'https://example.com/existing'],
        ]], 200)]);
    ...
    public function test_rss_fallback_fetches_news_when_api_keys_are_not_configured(): void
    {
        ...
        Http::fake(['news.google.com/*' => Http::response('<?xml version="1.0"?><rss><channel><item><title>CGPSC recruitment update - Example News</title><link>https://example.com/rss-one</link><description>Latest recruitment update from Chhattisgarh.</description><enclosure url="https://example.com/images/one.jpg" type="image/jpeg"/><pubDate>Tue, 08 Sep 2026 10:00:00 GMT</pubDate></item><item><title>Chhattisgarh education update - Another News</title><link>https://example.com/rss-two</link><description>Important education update from Chhattisgarh.</description><enclosure url="https://example.com/images/two.jpg" type="image/jpeg"/></item></channel></rss>', 200)]);
        ...
        $this->assertSame('https://example.com/images/one.jpg', News::first()->image_url);
    }
