...
<div class="flex justify-end gap-2 mt-4"><button type="button" onclick="document.getElementById('workflowStatus').value='draft';document.querySelector('form').submit()" class="px-5 py-2.5 rounded-xl border bg-white text-xs font-bold">Save as Draft</button><button class="px-6 py-2.5 rounded-xl bg-brand-600 text-white text-xs font-black">Save & Publish</button></div>
</form></div>
@endsection
